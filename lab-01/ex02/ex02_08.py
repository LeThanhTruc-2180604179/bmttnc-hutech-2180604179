...
# Tách chuỗi thành các số nhị phân và kiểm tra xem có chia hết cho 5 không
...
if len(so_chia_het_cho_5) > 0:
    ...
    print("Không có số nào trong chuỗi bạn nhập vào chia hết cho 5 trong chuỗi đã nhập.")